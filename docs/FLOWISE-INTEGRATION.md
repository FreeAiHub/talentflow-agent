...
- 🔗 **Интеграция с LLM** — поддержка OpenAI, Anthropic, Cohere, локальных моделей
...
GPT-4o-mini → Claude 3.5 Sonnet → Llama 3.1 (Local)

// Или использовать разные модели для разных задач
Анализ: GPT-4o-mini (быстро, дешево)
Генерация: Claude 3.5 (качество, креативность)
```
